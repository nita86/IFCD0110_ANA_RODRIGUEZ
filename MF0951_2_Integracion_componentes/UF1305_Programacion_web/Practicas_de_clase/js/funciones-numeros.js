...
function convertirNumero() {
	...
	"<p>La función de Número () convierte el argumento objeto a un número que representa el valor del objeto. Si el valor no se puede convertir en un número legal, se devuelve NaN.<br><strong>Nota:</strong> Si el parámetro es un objeto Date, la función Number () devuelve el número de milisegundos desde la medianoche del 1 de enero de, 1970 UTC.</p>";
	document.getElementById("contenedor2").style.display = "block";
}

//parseFloat()
function analizaCadena() {
...
document.getElementById("demo4").innerHTML = n; 
document.getElementById("demo3").innerHTML = 	
"<p>La función parseFloat () analiza una cadena y devuelve un número de coma flotante.<br> Esta función determina si el primer carácter de la cadena especificada es un número. Si lo es, se analiza la cadena hasta que llega al final de la serie, y devuelve el número como un número, no como una cadena.<br><strong>Nota:</strong> Sólo se devuelve el primer número de la cadena!<br><strong>Nota:</strong> se permiten espacios iniciales y finales.<br><strong>Nota:</strong> Si el primer carácter no puede ser convertido a un número, parseFloat () devuelve NaN.</p>";
document.getElementById("contenedor2").style.display = "block";
}
...
document.getElementById("demo4").innerHTML = n; 
document.getElementById("demo3").innerHTML = 	
"<p>La función parseInt () analiza una cadena y devuelve un entero.<br>El parámetro radix se utiliza para especificar qué sistema de numeración a ser utilizado, por ejemplo, un radix de 16 (hexadecimal) indica que el número en la cadena debe ser analizada de un número hexadecimal a un número decimal.Si se omite el parámetro radix, JavaScript supone lo siguiente:"+"<br"+
"<ul><li>Si la cadena comienza con 0x', la raíz es 16 (hexadecimal)</li><li>Si la cadena comienza con '0', la raíz es 8 (octal). Esta característica está en desuso</li><li>Si la cadena comienza con cualquier otro valor, la raíz es 10 (decimal)</li></ul>"+"<br>"+
"<p><strong>Nota:</strong> Sólo se devuelve el primer número de la cadena!<br><strong>Nota:</strong> se permiten espacios iniciales y finales.<br><strong>Nota:</strong> Si el primer carácter no puede ser convertido a un número, parseInt () devuelve NaN.</p>";
document.getElementById("contenedor2").style.display = "block";
}
